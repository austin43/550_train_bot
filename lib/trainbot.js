 ...
 */
 ...
 TrainBot.prototype._showTimes = function (input) {
    ...
    self.db.get(query, function (err, result) {
        ...
        self.postMessageToChannel(channel.name, 'The next train leaves at ' + result.origin_time + ' from ' + result.origin_station + ' and arrives at ' + result.destination_station + ' at ' + result.destination_time, {as_user: true});
